...
if ($traiter == 'ADD')
{
	...
	$person -> AddPers($persID, $persEmail, $persFirstName, $persLastName, $persDOB, $persPhone, $persFirstDay, $PhotoAvant, $persWorkHrs, $IdPost);*/
	// ----------------------
	// traitement photo ?
	...
	include('./Admin/fonctions/photo_adm.php');
	// ----------------------			
...
elseif ($traiter == 'EDIT')
{
	...
	$person -> EditPers($persID, $persEmail, $persFirstName, $persLastName, $persDOB, $persPhone, $persFirstDay, $PhotoAvant, $persWorkHrs, $IdPost);*/
	// ----------------------
	// traitement photo ?
	include('./Admin/fonctions/photo_adm.php');
...
<form method="post" name="formajouter" action="./Forms/employees.php">
	...
	<img src="<?php echo $DossierIcones; ?>user_add.png" width="24" alt="" /><span> Add another employee</span></button>
</form>
</div>
