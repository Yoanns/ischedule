<?php
// ***************************************************************************************
// Fonction pour modification du nom des photos
// ***************************************************************************************
...
function fctredimimage($W_max, $H_max, $rep_Dst, $img_Dst, $rep_Src, $img_Src) {
 ...
 if (file_exists($rep_Src.$img_Src) && ($W_max!=0 || $H_max!=0)) { 
   ...
   $ImageExtOK = '" jpg jpeg png"'; // (l espace avant jpg est important)
   ...
   if (strpos($ImageExtOK,$extension) != '') {
      // -----------------------------------------------
...
// ***************************************************************************************
// retourne : true si l ajout de texte a bien ete ajoute, sinon false
// ---------------------------------------------------------------------------------------
