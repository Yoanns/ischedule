...
<head>
	...
	<title>Shift-Scheduler.com | Requests off</title>
...
<div class="row">
	<div class="twelve columns centered">
		<div class="panel">
<h4 style="text-align:center">List of requests for time off</h4>
<br />
...
if ($Status  == 'PENDING')
	{ ?>
		<td style=" border:none; padding:5px;" width="6%">
			<div>
						<form method="post" name="formedit" action="adm_request_off.php">
