...
<br/>
<!-- formulaire -->
<form id="monForm" method="post" enctype="multipart/form-data" action="../treatment_admin.php">
<!--<fieldset>-->
...
<input type="hidden" name="PhotoAvant" value="<?php echo $PhotoAvant; ?>" />
	...
	<div class="row">
		<div class="seven columns">
			...
			<legend><h4 style="text-align:center;">PERSONAL INFORMATION</h4></legend>
			<p>
            ...
            <p>
				...
				<input type="text" name="DOB" id="DOB" value="<?php echo $persDOB; ?>" required>
				<input type="text" id="alternate" size="16" disabled="disabled">
			</p>
            <p>
            ...
            <p>
				...
				<input type="text" name="FirstDay" id="FirstDay" required value="<?php echo $persFirstDay; ?>"/>
				<input type="text" id="altern" size="16" disabled="disabled">
			</p>
            <p>
...
$post=new post(null);
	if(false!=$post->Listing())
	   ...
	   ?>
            ...
            <br/>
           <?php /*?> <p>
				<label class="label14" for="DayEvt" style="text-align:right;"> Department<br/><span style="color:#808080; font-size:8pt;">Select a department</span></label>
				 <select name="IdDept" id="IdDept" required="required" >
								 <option value=""></option>
            <?php

	$dept = new department(null);
	if (false!=$dept->Listing())
		$listdept=$dept->Listing();
		
	  	if (!empty($listdept))
	  	{
	  		while ($row=mysql_fetch_array($listdept))
			{
	  	?>
            <option value="<?php echo $row[0]; ?>" <?php if ($row[0] == $IdDept) echo  'selected="selected"' ;?> ><?php echo $row[1]." - ".$row[2]; ?></option>
...
<div class="row">
	<div class="six columns">
		<p style="text-align:center;">            
         		<button name="addpers" type="submit" value="<?php echo $traiter; ?>" class="large radius button green"><img src="../Admin/icones/<?php echo $traiter; ?>.png" alt="" /><span><?php echo $traiter; ?> Employee </span></button>	
		</p>
	</div> <!--End 6 cols-->
	
	<div class="six columns">
				<a href="../admin_spr.php#nice2"><div class="large radius button red" ><img src="../Admin/icones/ANNULER.png" alt="" /><span> Cancel</span></div></a>	
	</div> <!--End 6 cols-->
</div>	<!--End row-->
<br/>
...
?>
	<!-- photo -->
	<legend><h4 style="text-align:center;">ADD A PICTURE</h4></legend>
...
?>
		...
		<fieldset>
		<legend><h4 style="text-align:center;">SKILLS</h4></legend>
		...
		<legend><h4 style="text-align:center;">AVAILABILITY</h4></legend>
