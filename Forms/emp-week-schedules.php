...
<a class="red button" href="../empl_site.php#simpleContained1"><img src="../Admin/icones/arrow_back.png" alt="" /> Go Back</a>
</div>
...
?>
 	<tr><td colspan="8" style="border:thin dotted #666666; padding:5px;">No employee for now.</td></tr>
<?php
} // End else
} // end while post
?>			
...
<!-- lien retour -->
<div class="VALIDATION-FINALE">
<a href="../empl_site.php#simpleContained1"><div class="large button red" ><img src="../Admin/icones/arrow_back.png" alt="" /> Go back</div></a>	
</div>
