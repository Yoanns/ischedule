...
<head>
	...
	<title>Shift-Scheduler.com | Seeing all the schedules</title>
...
function replaceDoc()
  ...
  document.location.replace("see-all-schedules.php?Day="+x);
  }
</script>
...
<h1>Seeing all the schedules</h1>
...
<form name="DayChoice" id="DayChoice" method="GET" >		
	<p style="text-align:center" align="center">
		<label class="centered" for="Subject">Week : 
...
<?php
//Info about the schedules of the selected day
...
<div class="row">
	...
	<table>
			...
			<tr>
				...
				<td style="border:thin dashed #666666; padding:5px; width:6%">Hours</td>
			</tr>
			</thead>
...
?>			
			<tr>
				<th style="border:thin dashed #666666; padding:5px;"><?php echo $FirstName." ".$LastName; ?></th>
...
?>
			  	<td style="border:thin dashed #666666; padding:5px;"><?php echo $BegShift." - ".$EndShift; ?></td>
<?php
	} // End while
	} // End if
elseif ($nb_sun == 0)
...
?>
				...
				<td style="border:thin dashed #666666; padding:5px;"><?php echo $cnt." / ".$WorkHrs; ?></td>
			</tr>
<?php
} // end while pers row
}// end if pers
