...
function replaceDoc()
  ...
  document.location.replace("see-all-event.php?Day="+x);
  }
</script>
...
<?php 
		$evt = new event(null);
		$EvtDay = $evt -> DayEvents($DayEvt,$IdLoc);
...
if ($evt_num > 0)
			...
			<tr style="border:1px dashed #CCCCCC">
				...
				<td>
					<div style="float:left;">
						<form method="post" name="formmodifier" action="./events.php">
				...
				<td>
					<div style="float:left;">
						<form method="post" name="formmodifier" action="./evt_treatment.php">
	...
	<form method="post" name="formmodifier" action="./print-day-event.php" target="_blank">
...
<a href="../admin.php#nice1"><div class="large button red" ><img src="../Admin/icones/arrow_back.png" alt="" /> Go back</div></a>
</div>
