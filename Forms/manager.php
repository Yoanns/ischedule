...
if ($traiter == 'ADD')
{
	...
	$query_add = 	"SELECT IdPers, LastName, FirstName FROM person 
					...
					AND IdPers IN (SELECT IdPers FROM person P, post Ps WHERE P.IdPost = Ps.IdPost AND Ps.IdDept = '".$_SESSION["IdDept"]."')
					ORDER BY LastName";
	...
	?>
		...
		<?php
			...
			?>
				...
				<div class="row">
                                <button name="addManager" type="submit" value="<?php echo $traiter; ?>" class="large button green">
