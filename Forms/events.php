...
$(document).ready(function() {
    $("#NbGuest").keydown(function(event) {
	...
	// Disable right click
	$("#NbGuest").bind("contextmenu",function(e){
	        return false;
	    });
...
<div class="row">
	<div class="twelve columns centered">
		<div class="panel">
<!-- formulaire -->
<form id="EvtForm" method="post" enctype="multipart/form-data" action="../evt_treatment.php">
<fieldset>
...
<div class="row">
	...
	<p>
		...
		<input type="text" id="NameEvt" name="NameEvt" size="30" value="<?php echo $NameEvt;?>" required/>
	</p>
	<p>
		<label for="NbGuest">Number of guests : </label>
		<input type="text" id="NbGuest" name="NbGuest" type="digits" value="<?php echo $GuestEvt;?>" size="30" required/>
	</p>
	<p>
		<label for="BegEvt">Event's start : </label>
		<input type="text" id="BegEvt" name="BegEvt" size="30" value="<?php echo $BegEvt;?>" required />
	</p>
	<p>
		<label for="EndEvt">Event's end : </label>
		<input type="text" id="EndEvt" name="EndEvt" size="30" value="<?php echo $EndEvt;?>" required />
	</p>
</div><!-- End 6 cols-->
...
<div class="row">
	...
	<p style="text-align:center;">
		<button name="evtsubmit" type="submit" title="Save event" class="large radius blue button">Save event</button>
	</p>
	</div> <!--End panel-->
</div> <!--End 12 cols-->
	</fieldset>
...
<a href="../admin.php#nice1" title="Go back"><div class="large radius button red" ><img src="../Admin/icones/arrow_back.png" alt="" /> Go back</div></a>		
 </div>
 </div>
