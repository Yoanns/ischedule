...
if (isset($_POST['traiter']) && ($_POST['traiter']=='ADD' || $_POST['traiter']=='EDIT')){
	...
	header('location: ../admin_spr.php#nice2');
	exit;
}
...
<!-- formulaire -->
	<form id="PostForm" method="post" enctype="multipart/form-data" action="../post_treatment_adm.php">
		<fieldset>
	...
	if (false!=$dept->Listing())
		$listdept=$dept->Listing();
	  	...
	  	?>
            <option value="<?php echo $DeptID; ?>" <?php if ($DeptID == $IdDept) echo  'selected="selected"' ;?> ><?php echo $NameDept." - ".$NameLoc; ?></option>
  ...
  <div class="row">
	<div class="six  centered columns">
		<p style="text-align:center;">            
         		<button name="addpost" type="submit" value="<?php echo $traiter; ?>" class="large button green"><img src="../Admin/icones/<?php echo $traiter; ?>.png" alt="" /><?php echo $traiter; ?> position </button>	
		</p>
	</div> <!--End 6 cols-->
</div>	<!--End row-->
						<br/>
...
<div class="row">	
	<div class="twelve columns centered">
				<a href="../admin_spr.php#nice2" ><div class="large button red" ><img src="../Admin/icones/arrow_back.png" alt="" /> Go back</div></a>	
	</div> <!--End 6 cols-->
</div>	
