...
$targetpage = $_SERVER["PHP_SELF"]; 	
	...
	$query = "SELECT COUNT(*) AS num 
				FROM messages 
				WHERE  `FromEmp` = '$FromEmp' AND `Deleted` = '0' ";
...
$msg_query = "SELECT * FROM messages WHERE `FromEmp` = '$FromEmp' AND `Deleted` = '0' ORDER BY `DateSent` DESC LIMIT $start, $limit";
...
<div class="row">
	<div class="twelve centered columns">
				...
				while($msg_row = mysql_fetch_array($msg_result)) 
					{
						...
						$ToEmp = stripslashes($msg_row["ToEmp"]);
        				...
        				<tr>
							<td><form method="post" name="formsupprimer" action="outbox.php" onClick="return confirm('Do you really want to delete this message definitely?')">
		...
		<button name="btDEL" type="submit" title="Delete message" class="button"><img src="../Admin/icones/bin_empty.png" width="24" alt="Delete message" /></button>
							...
							<td><?php echo $ToEmp;?></td>
							<td style="text-align:left;"><a href="outview.php?IdMsg=<?php echo $IdMsg;?>"><?php echo $Subject;?></a></td>
