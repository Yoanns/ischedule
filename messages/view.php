...
while ($pers_row = mysql_fetch_array($pers_result))
{
	...
	$IdMsg = @$_GET['IdMsg'];
        ...
        elseif(isset($IdMsg)) {
                ...
                $msg_query ="SELECT * FROM messages WHERE ToEmp = '$ToEmp' AND `IdMsg` = '$IdMsg'";
...
<?php
            ...
            while($msg_row= mysql_fetch_array($msg_result)) 
				{               
				  ...
				  <p><strong>Received on: </strong><?php echo $DateSent ;?></p>
...
<a href="inbox.php" title="Go back"><div class="large button red"><img src="../Admin/icones/arrow_back.png" alt="Go back" />Go back</div></a>	
 </div>
 </div>
